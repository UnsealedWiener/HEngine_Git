...
public:
    ...
    ID3D12GraphicsCommandList* GetCommandList() { return mList.Get(); }
...
ID3D12GraphicsCommandList* __cdecl ResourceUploadBatch::GetCommandList()
{
    return pImpl->GetCommandList();
}
