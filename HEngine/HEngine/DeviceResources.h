...
namespace DX
{
    ...
    public:
        ...
        void Initialize(DXGI_FORMAT backBufferFormat = DXGI_FORMAT_B8G8R8A8_UNORM,
            DXGI_FORMAT depthBufferFormat = DXGI_FORMAT_D32_FLOAT,
            UINT backBufferCount = 2,
            D3D_FEATURE_LEVEL minFeatureLevel = D3D_FEATURE_LEVEL_11_0,
        ...
        void Prepare();
        void SetScreenSizeViewport()const;
        void SetShadowMapViewport()const;
        void SetUiViewPort()const;
        ...
        IDXGIAdapter3*              GerAdapter3()const              { return m_dxgiAdapter.Get(); }
        ID3D12Device5*              GetRaytracingDevice()const      { return m_dxrDevice.Get(); }
        ID3D12GraphicsCommandList4* GetRaytracingCommandList()const { return m_dxrCommandList.Get(); }
        bool                        IsRaytracingSupported()const    { return m_bRaytracingSupported;}
        bool                        IsMsaaSupported()const          { return m_bMsaaSupported; }
        unsigned int                GetSampleCount()const           { return m_sampleCount; }
        unsigned int                GetSampleQuality()const         { return m_sampleQuality; }
    ...
    private:
        ...
        // Msaa
        bool							                    m_bMsaaSupported = false;
        const UINT						                    c_targetSampleCount = 4;
